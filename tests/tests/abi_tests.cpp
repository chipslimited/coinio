...
#include <cps/types/abi_serializer.hpp>
#include <cps/abi_generator/abi_generator.hpp>

#include "../common/database_fixture.hpp"

using namespace cpsio;
using namespace chain;
using namespace cpsio::types;
...
{ try {
  ...
  if( std::getenv("CPSLIB") == nullptr ) {
    wlog("*************************************");
    wlog("*  CPSLIB env variable not defined  *");
    wlog("*  ABIGenerator tests will not run  *");
    wlog("*************************************");
    return;
  }

  auto is_abi_generation_exception =[](const cpsio::abi_generation_exception& e) -> bool { return true; };

  auto generate_abi = [this](const char* source, const char* abi, bool opt_sfs=false) -> bool {
    
    const char* cpslib_path = std::getenv("CPSLIB");
    FC_ASSERT(cpslib_path != NULL);

    std::string include_param = std::string("-I") + cpslib_path;
    
    cpsio::types::abi output;
    ...
    auto abi1 = fc::json::from_string(abi).as<cpsio::types::abi>();
   ...
   BOOST_CHECK_EXCEPTION( generate_abi(unknown_type, ""), cpsio::abi_generation_exception, is_abi_generation_exception );
   
   const char* all_types = R"=====(
    #include <cpslib/types.hpp>
    #include <cpslib/string.hpp>
  ...
  BOOST_CHECK_EQUAL( generate_abi(all_types, all_types_abi), true );
   ...
   BOOST_CHECK_EXCEPTION( generate_abi(double_base, ""), cpsio::abi_generation_exception, is_abi_generation_exception );
   ...
   BOOST_CHECK_EXCEPTION( generate_abi(unable_to_determine_index, ""), cpsio::abi_generation_exception, is_abi_generation_exception );
  ...
  // typedef fixed_string16 FieldName;
   ...
   BOOST_CHECK_EXCEPTION( generate_abi(long_field_name, ""), cpsio::abi_generation_exception, is_abi_generation_exception );
   ...
   BOOST_CHECK_EXCEPTION( generate_abi(long_type_name, "{}"), cpsio::abi_generation_exception, is_abi_generation_exception );
   ...
   BOOST_CHECK_EXCEPTION( generate_abi(same_type_different_namespace, ""), cpsio::abi_generation_exception, is_abi_generation_exception );
   ...
   BOOST_CHECK_EXCEPTION( generate_abi(bad_index_type, ""), cpsio::abi_generation_exception, is_abi_generation_exception );
   ...
   BOOST_CHECK_EXCEPTION( generate_abi(union_table, ""), cpsio::abi_generation_exception, is_abi_generation_exception );
   ...
   BOOST_CHECK_EXCEPTION( generate_abi(same_action_different_type, ""), cpsio::abi_generation_exception, is_abi_generation_exception );
...
{ try {
   ...
   const char *my_other = R"=====(
    {
      "publickey"     :  "CPS6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV",
      "publickey_arr" :  ["CPS6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV","CPS6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV","CPS6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV"],
      "asset"         : "100.00 CPS",
      "asset_arr"     : ["100.00 CPS","100.00 CPS"],
      "price"         : { "base" : "100.00 CPS", "quote" : "200.00 BTC" },
      "price_arr"     : [{ "base" : "100.00 CPS", "quote" : "200.00 BTC" },{ "base" : "100.00 CPS", "quote" : "200.00 BTC" }],
      ...
      "kpweight": {"key":"CPS6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV", "weight":"100"},
      "kpweight_arr": [{"key":"CPS6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV", "weight":"100"},{"key":"CPS6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV", "weight":"200"}],
      "authority": { 
         "threshold":"10", 
         "keys":[{"key":"CPS6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV", "weight":"100"},{"key":"CPS6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV", "weight":"200"}],
      ...
      "blkcconfig": {"max_blk_size": "100","target_blk_size" : "200", "max_storage_size":"300","elected_pay" : "400", "runner_up_pay" : "500", "min_cps_balance" : "600", "max_trx_lifetime"  : "700"},
      "blkcconfig_arr": [
        {"max_blk_size": "100","target_blk_size" : "200", "max_storage_size":"300","elected_pay" : "400", "runner_up_pay" : "500", "min_cps_balance" : "600", "max_trx_lifetime"  : "700"},
        {"max_blk_size": "100","target_blk_size" : "200", "max_storage_size":"300","elected_pay" : "400", "runner_up_pay" : "500", "min_cps_balance" : "600", "max_trx_lifetime"  : "700"}
      ],
...
{ try {
   ...
   abi_serializer abis(native_contract::native_contract_chain_initializer::cps_contract_abi());
   ...
   auto transfer = var.as<cpsio::types::transfer>();
   ...
   auto transfer2 = var2.as<cpsio::types::transfer>();
...
{ try {
   ...
   auto lock = var.as<cpsio::types::lock>();
   ...
   auto lock2 = var2.as<cpsio::types::lock>();
...
{ try {
   ...
   auto unlock = var.as<cpsio::types::unlock>();
   ...
   auto unlock2 = var2.as<cpsio::types::unlock>();
...
{ try {
   ...
   auto claim = var.as<cpsio::types::claim>();
   ...
   auto claim2 = var2.as<cpsio::types::claim>();
...
{ try {
   ...
   auto okproducer = var.as<cpsio::types::okproducer>();
   ...
   auto okproducer2 = var2.as<cpsio::types::okproducer>();
...
{ try {
   ...
   {
     "name" : "acct.name",
     "key" : "CPS5PnYq6BZn7H9GvL68cCLjWUZThRemTJoJmybCn1iEpVUXLb5Az",
     "configuration" : {
        ...
        "min_cps_balance" : -9223372036854775707,
   ...
   auto setproducer = var.as<cpsio::types::setproducer>();
   BOOST_CHECK_EQUAL("acct.name", setproducer.name);
   BOOST_CHECK_EQUAL("CPS5PnYq6BZn7H9GvL68cCLjWUZThRemTJoJmybCn1iEpVUXLb5Az", (std::string)setproducer.key);
   ...
   BOOST_CHECK_EQUAL(-9223372036854775707, setproducer.configuration.min_cps_balance);
   ...
   auto setproducer2 = var2.as<cpsio::types::setproducer>();
   ...
   BOOST_CHECK_EQUAL(setproducer.configuration.min_cps_balance, setproducer2.configuration.min_cps_balance);
...
{ try {
   ...
   auto setproxy = var.as<cpsio::types::setproxy>();
   ...
   auto setproxy2 = var2.as<cpsio::types::setproxy>();
...
{ try {
   ...
   auto linkauth = var.as<cpsio::types::linkauth>();
   ...
   auto linkauth2 = var2.as<cpsio::types::linkauth>();
...
{ try {
   ...
   auto unlinkauth = var.as<cpsio::types::unlinkauth>();
   ...
   auto unlinkauth2 = var2.as<cpsio::types::unlinkauth>();
...
{ try {
   ...
   const char* test_data = R"=====(
   {
     ...
     "new_authority" : {
        ...
        "keys" : [ {"key" : "CPS65rXebLhtk2aTTzP4e9x1AQZs7c5NNXJp89W8R3HyaA6Zyd4im", "weight" : 57005},
                   {"key" : "CPS5eVr9TVnqwnUBNwf9kwMTbrHvX5aPyyEG97dz2b2TNeqWRzbJf", "weight" : 57605} ],
   ...
   auto updateauth = var.as<cpsio::types::updateauth>();
   ...
   BOOST_CHECK_EQUAL("CPS65rXebLhtk2aTTzP4e9x1AQZs7c5NNXJp89W8R3HyaA6Zyd4im", (std::string)updateauth.new_authority.keys[0].key);
   BOOST_CHECK_EQUAL(57005u, updateauth.new_authority.keys[0].weight);
   BOOST_CHECK_EQUAL("CPS5eVr9TVnqwnUBNwf9kwMTbrHvX5aPyyEG97dz2b2TNeqWRzbJf", (std::string)updateauth.new_authority.keys[1].key);
   ...
   auto updateauth2 = var2.as<cpsio::types::updateauth>();
...
{ try {
   ...
   auto deleteauth = var.as<cpsio::types::deleteauth>();
   ...
   auto deleteauth2 = var2.as<cpsio::types::deleteauth>();
...
{ try {
   ...
   auto newaccount = var.as<cpsio::types::newaccount>();
   ...
   BOOST_CHECK_EQUAL("CPS65rXebLhtk2aTTzP4e9x1AQZs7c5NNXJp89W8R3HyaA6Zyd4im", (std::string)newaccount.owner.keys[0].key);
   BOOST_CHECK_EQUAL(57005u, newaccount.owner.keys[0].weight);
   BOOST_CHECK_EQUAL("CPS5eVr9TVnqwnUBNwf9kwMTbrHvX5aPyyEG97dz2b2TNeqWRzbJf", (std::string)newaccount.owner.keys[1].key);
   ...
   BOOST_CHECK_EQUAL("CPS65rXebLhtk2aTTzP4e9x1AQZs7c5NNXJp89W8R3HyaA6Zyd4im", (std::string)newaccount.active.keys[0].key);
   BOOST_CHECK_EQUAL(57005u, newaccount.active.keys[0].weight);
   BOOST_CHECK_EQUAL("CPS5eVr9TVnqwnUBNwf9kwMTbrHvX5aPyyEG97dz2b2TNeqWRzbJf", (std::string)newaccount.active.keys[1].key);
   ...
   BOOST_CHECK_EQUAL("CPS65rXebLhtk2aTTzP4e9x1AQZs7c5NNXJp89W8R3HyaA6Zyd4im", (std::string)newaccount.recovery.keys[0].key);
   BOOST_CHECK_EQUAL(57005u, newaccount.recovery.keys[0].weight);
   BOOST_CHECK_EQUAL("CPS5eVr9TVnqwnUBNwf9kwMTbrHvX5aPyyEG97dz2b2TNeqWRzbJf", (std::string)newaccount.recovery.keys[1].key);
   ...
   BOOST_CHECK_EQUAL(CPS_SYMBOL, newaccount.deposit.symbol);

   auto var2 = verify_round_trip_conversion( abis, "newaccount", var );
   auto newaccount2 = var2.as<cpsio::types::newaccount>();
