...
#include <cps/chain/fork_database.hpp>
#include <cps/chain/block_log.hpp>
...
#include <cps/chain/wasm_interface.hpp>
...
#include <cps/chain/staked_balance_objects.hpp>
#include <cps/chain/balance_object.hpp>
#include <cps/native_contract/genesis_state.hpp>

#include <cps/utilities/key_conversion.hpp>
#include <cps/chain/wast_to_wasm.hpp>
...
{ try {
   ...
   cpsio::chain::applied_irreverisable_block_func applied_func;
...
read_only::get_account_results read_only::get_account( const get_account_params& params )const {
   ...
   result.cps_balance          = asset(balance.balance, CPS_SYMBOL);
