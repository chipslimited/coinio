...
#include <cps/chain/key_value_object.hpp>
#include <cps/chain/account_object.hpp>
...
namespace cpsio {
   using cpsio::chain::chain_controller;
...
public:
   ...
   struct get_account_results {
      name                       account_name;
      asset                      cps_balance = asset(0,CPS_SYMBOL);
...
public:
   ...
   // return true if --skip-transaction-signatures passed to cpsd
...
FC_REFLECT( cpsio::chain_apis::permission, (perm_name)(parent)(required_auth) )
FC_REFLECT(cpsio::chain_apis::empty, )
FC_REFLECT(cpsio::chain_apis::read_only::get_info_results,
...
FC_REFLECT(cpsio::chain_apis::read_only::get_block_params, (block_num_or_id))
...
FC_REFLECT( cpsio::chain_apis::read_only::get_account_results, (account_name)(cps_balance)(staked_balance)(unstaking_balance)(last_unstaking_time)(permissions)(producer) )
FC_REFLECT( cpsio::chain_apis::read_only::get_code_results, (account_name)(code_hash)(wast)(abi) )
FC_REFLECT( cpsio::chain_apis::read_only::get_account_params, (account_name) )
FC_REFLECT( cpsio::chain_apis::read_only::get_code_params, (account_name) )
FC_REFLECT( cpsio::chain_apis::read_only::producer_info, (producer_name) )
FC_REFLECT( cpsio::chain_apis::read_only::abi_json_to_bin_params, (code)(action)(args) )
FC_REFLECT( cpsio::chain_apis::read_only::abi_json_to_bin_result, (binargs)(required_scope)(required_auth) )
FC_REFLECT( cpsio::chain_apis::read_only::abi_bin_to_json_params, (code)(action)(binargs) )
FC_REFLECT( cpsio::chain_apis::read_only::abi_bin_to_json_result, (args)(required_scope)(required_auth) )
FC_REFLECT( cpsio::chain_apis::read_only::get_required_keys_params, (transaction)(available_keys) )
FC_REFLECT( cpsio::chain_apis::read_only::get_required_keys_result, (required_keys) )
